...
def simplify_submodule(submodule: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "sections": [simplify_section(section) for section in submodule.get("sections", [])],
    }
...
def simplify_module(module_data: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "submodules": [simplify_submodule(submodule) for submodule in module_data.get("submodules", [])],
    }
